...
<div class="main-page">
    <div class="container">
        <div class="login-page-signup">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="login-heading">Apply for New block!</h1>
                    <h4 class="login-heading2" style="color:#000"><?php echo $Message;?></h4>
                    <form role="form" action="blockapplyfinal.php" method="post" id="add_reg">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn bg-btn">Search your Block!</button>
                        </div>
                    </form>
                </div>
            </div>
